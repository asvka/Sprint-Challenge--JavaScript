...
console.log(trexStats.weight);

// What was the diet of a velociraptor?
console.log(velStats.diet);

// How long was a stegosaurus?
console.log(stegStats.lengthM);

// What time period did tyrannosaurus live in?
console.log(trexStats.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
trexStats.prototype.roar = function() {
  console.log("RAWERSRARARWERSARARARRRR!")
}
console.log(trexStats.roar);
...
let contactInfo = [];
for (let i = 0; i < graduates.length; i++){
  contactInfo.push(graduates[i]"names" +" "+ graduates[i]"email");
}
...
const lowCaseAnimalNames = zooAnimals.map((x) => {
